...
if [ -f kiirocoin-1.0.0.4-linux-18.04.zip ] ; then
    sudo rm kiirocoin-1.0.0.4-linux-18.04.zip
fi
...
wget github.com/Kiirocoin/kiiro/releases/download/v1.0.0.4/kiirocoin-1.0.0.4-linux-18.04.zip
printf "${hr}Done${hr}"
banner
